...
// -------------
// Gravity Forms Push API Main Program Entry Point
// -------------
...
/**
 * Return the Destination API URL based on the environment or the script IP address
 *
 * @return string
 */
function getLeadsApiUrl()
{
	...
	if ($bis_environment == 'production') {
		return "https://production-url/api/v1";
	}
    
	if ($_SERVER['SERVER_ADDR'] == "127.0.0.1") {
		return "https://localhost-testing-url/api/v1";
    }
    
	return "https://development-url/api/v1";
}
...
{	
	...
	$body = [
		'api_token'      => $_SERVER['BIS_API_TOKEN'],
